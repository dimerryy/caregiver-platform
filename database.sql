-- CSCI 341 Assignment 3 - Part 1: Complete Database Setup
-- Caregiver Platform Database
-- Database: PostgreSQL
-- This file contains both schema creation and sample data
...
-- Insert USERS (30 total: 15 caregivers, 15 members)
...
-- Insert CAREGIVERS (15 instances)
...
-- Insert ADDRESSES (15 instances, one per member)
...
-- Insert JOB_APPLICATIONS (45 instances)
...
-- Insert APPOINTMENTS (25 instances with various statuses)
